...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		_talon2.config_kF(Constants.kPIDLoopIdx, 0.0, Constants.kTimeoutMs);
		_talon2.config_kP(Constants.kPIDLoopIdx, 0.1, Constants.kTimeoutMs);
		_talon2.config_kI(Constants.kPIDLoopIdx, 0.0, Constants.kTimeoutMs);
		_talon2.config_kD(Constants.kPIDLoopIdx, 0.0, Constants.kTimeoutMs);
		_talon1.set(ControlMode.Follower, 0);
		_talon3.set(ControlMode.Follower, 2);
		/*
